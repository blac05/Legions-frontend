    ...
    <div className="px-6 md:px-9 pb-10">
      ...
      <div className="flex flex-col gap-3">
        {escrows.map((e) => {
          ...
          const releasedCount = e.milestones.filter((m) => m.released).length;
          return (
                ...
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    <div className="f-body" style={{ fontSize: 12.5, color: C.muted, marginTop: 2 }}>
                      with {cp.name} · you are {roleOf(e) === "depositor" ? "the depositor" : "the beneficiary"} · {releasedCount}/{e.milestones.length} milestones released
                    </div>
                  </div>
